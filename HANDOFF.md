...
**Último cambio: 2026-06-26.**
Surfacing de `proyectos.notas` en UI (commit `82b32c4`: ficha + reporte + form) y actualización semanal 2026-06-26 (solo datos: 5 alertas resueltas, 4 actualizadas, 3 nuevas Zurich → activo 4 críticas / 11 importantes / 5 seguimiento; contexto Zurich + CLC; notas Zurich + CLC). Previas: actualización semanal 2026-06-25 (migración `09_proyectos_notas`), M7 (Adiciones v4: Hitos + Reportes + Presentación semanal, migración `08_hitos`), `57943c4` M6 + carga de datos v1.0, `cc9ef41` M5, `52b2b83` M1/M2/M3/M4.
